...
POWER_PIN = 26  # GPIO pin that provides power to the rain sensor
DO_PIN = 32     # GPIO pin connected to the DO pin of the rain sensor
...
def loop():
    ...
    time.sleep(3)  # pause for 3 seconds to avoid reading sensors frequently and prolong the sensor lifetime
